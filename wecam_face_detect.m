...
close;
clc;
vid = imaq.VideoDevice('winvideo', 1); % Acquire input video stream
...
while(nFrame < 10)
    ...
    frame = step(vid); % Acquire single frame
        recorte=frame((399-40):(399+40),(406-40):(406+40));
        recorbin1=imbinarize(recorte,umbral);
        recorte2=frame((344-40):(344+40),(532-40):(532+40));
        recorbin2=imbinarize(recorte2,umbral);
